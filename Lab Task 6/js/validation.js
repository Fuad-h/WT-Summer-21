function validateForm()
 {
    ...
    if (fname == "") {
     document.getElementById("err-fname").innerHTML="Please fill the your name";
      return false;
    }
    if(email == ""){
      ...
      document.getElementById("err-email").innerHTML="Email format is not ok";
      return false; 
    }
    if (pass == "") {
     document.getElementById("err-pass").innerHTML="Please enter the password";
      return false;
    ...
    if (!male.checked && !female.checked && !other.checked) {
        document.getElementById("err-gender").innerHTML="---Choose Gender";
        return false;
    }
